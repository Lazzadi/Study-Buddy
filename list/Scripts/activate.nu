...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\lazar\OneDrive\Documents\Python\Python Django 7 hour course\list'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\lazar\OneDrive\Documents\Python\Python Django 7 hour course\list\Scripts\deactivate.nu'
